...
/*  Created On : 06-nov-2018 09:33:32 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	"tootaja_seisundi_liik_kood" char NOT NULL DEFAULT 1,
	"mentor" integer NULL
)
;
...
(
	"isik_id" integer NOT NULL,
	"kliendi_seisundi_liik_kood" char NOT NULL DEFAULT 1,
...
(
	...
	"auto_kytuse_liik_kood" smallint NOT NULL,
	"auto_mark_kood" smallint NOT NULL,
	"auto_seisundi_liik_kood" char(1)	 NOT NULL DEFAULT 'P',
	"isik_id" integer NOT NULL,
