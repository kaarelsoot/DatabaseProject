...
(
	...
	CONSTRAINT "chk_amet_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_auto_kategooria_nimetus_pole_tyhi" CHECK (trim(nimetus) <> ''),
...
(
	...
	CONSTRAINT "chk_auto_kategooria_tyyp_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_auto_kytuse_liik_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_auto_mark_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_auto_seisundi_liik_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_isiku_seisundi_liik_isiku_seisundi_liik_kood_pole_tyhi" CHECK (trim(isiku_seisundi_liik_kood) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_kliendi_seisundi_liik_kliendi_seisundi_liik_kood_pole_tyhi" CHECK (trim(kliendi_seisundi_liik_kood) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_riik_nimetus_pole_tyhi" CHECK (trim(nimetus) <> '')
)
;
...
(
	...
	CONSTRAINT "chk_tootaja_seisundi_liik_tootaja_seisundi_liik_kood_pole_tyhi" CHECK (trim(tootaja_seisundi_liik_kood) <> '')
)
;
...
(
	...
	synni_kp<'2101-01-01'),
	CONSTRAINT "chk_isik_reg_aeg_vahemikus" CHECK (reg_aeg>='2010-01-01' AND
	reg_aeg<'2101-01-01'),
...
(
	...
	CONSTRAINT "chk_auto_reg_aeg_vahemikus" CHECK (reg_aeg>='2010-01-01' AND
	reg_aeg<'2101-01-01'),
